...
#### Set the workstation
setwd("/home/qiwen/r/08052016RFDistanceAndSim/rd14_dna/")
...
for(i in 1:10){
  ...
  res_07 <- fNum(cValue[2],sNum[i])
  res_08 <- fNum(cValue[3],sNum[i])
  res_09 <- fNum(cValue[4],sNum[i])
  res_10 <- fNum(cValue[5],sNum[i])
  res_12 <- fNum(cValue[6],sNum[i])
  res_14 <- fNum(cValue[7],sNum[i])
  res_16 <- fNum(cValue[8],sNum[i])
  res_18 <- fNum(cValue[9],sNum[i])
  res_20 <- fNum(cValue[10],sNum[i])
  res_40 <- fNum(cValue[11],sNum[i])
  res_60 <- fNum(cValue[12],sNum[i])
  ...
  dataOneTreeOne[[i]] <- rbind(res_06[[1]][3],res_07[[1]][3],res_08[[1]][3],
                               res_09[[1]][3],res_10[[1]][3],res_12[[1]][3],
                               res_14[[1]][3],res_16[[1]][3],res_18[[1]][3],
                               res_20[[1]][3],res_40[[1]][3],res_60[[1]][3])
  
  
  dataTwoTreeOne[[i]] <- rbind(res_06[[2]][3],res_07[[2]][3],res_08[[2]][3],
                               res_09[[2]][3],res_10[[2]][3],res_12[[2]][3],
                               res_14[[2]][3],res_16[[2]][3],res_18[[2]][3],
                               res_20[[2]][3],res_40[[2]][3],res_60[[2]][3])
    
  
  dataOneTreeTwo[[i]] <- rbind(res_06[[3]][3],res_07[[3]][3],res_08[[3]][3],
                               res_09[[3]][3],res_10[[3]][3],res_12[[3]][3],
                               res_14[[3]][3],res_16[[3]][3],res_18[[3]][3],
                               res_20[[3]][3],res_40[[3]][3],res_60[[3]][3])
  
  dataTwoTreeTwo[[i]] <- rbind(res_06[[4]][3],res_07[[4]][3],res_08[[4]][3],
                               res_09[[4]][3],res_10[[4]][3],res_12[[4]][3],
...
shapeClean<-function(TreeOne,TreeTwo){
  ...
  rownames(treeOnePoint) <- c(0.6,0.7,0.8,0.9,1,1.2,1.4,1.6,1.8,2,4,6)
  rownames(treeTwoPoint) <- c(0.6,0.7,0.8,0.9,1,1.2,1.4,1.6,1.8,2,4,6)
